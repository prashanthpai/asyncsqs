...
func (_m *SqsClient) DeleteMessageBatch(_a0 context.Context, _a1 *sqs.DeleteMessageBatchInput, _a2 ...func(*sqs.Options)) (*sqs.DeleteMessageBatchOutput, error) {
...
func (_m *SqsClient) SendMessageBatch(_a0 context.Context, _a1 *sqs.SendMessageBatchInput, _a2 ...func(*sqs.Options)) (*sqs.SendMessageBatchOutput, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
